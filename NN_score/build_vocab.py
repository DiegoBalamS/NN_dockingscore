...
def main():
    ...
    parser.add_argument('--corpus_path', '-c', type=str, default='project/chembl24_corpus.txt', help='path to th ecorpus')
    parser.add_argument('--out_path', '-o', type=str, default='project/vocab.pkl', help='output file')
