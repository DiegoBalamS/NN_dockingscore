...
def main():
    ...
    parser.add_argument('--in_path', '-i', type=str, default='project/chembl_24.csv', help='input file')
    parser.add_argument('--out_path', '-o', type=str, default='project/chembl24_corpus.txt', help='output file')
